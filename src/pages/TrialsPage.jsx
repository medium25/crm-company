      ...
      <SearchField
        ...
        trailing={
          <button
            ...
            style={{ borderColor: TRIAL_SCHEDULED_COLOR, color: TRIAL_SCHEDULED_COLOR }}
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-field border-2 bg-white transition hover:bg-surface-alt"
          >
