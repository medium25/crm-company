...
export const COLUMNS = [
  ...
  },
  {
    ...
    label: 'Дозвон',
    color: '#E5842B',
    // Не регулируется через ⚙ (в отличие от 'closing') — жёстко привязано
    // к сетке дедлайнов «2 сегодня/2 завтра/1 послезавтра» в nextCallDueAt
    // (leadFunnel.js) и к порогу автопереноса в «Отказ»/«Холодный лид»
    // (LeadsPage.jsx) — 5 везде одно и то же число, менять его тут без
    // синхронного пересчёта той сетки означало бы разъехавшееся поведение.
    hint: {
