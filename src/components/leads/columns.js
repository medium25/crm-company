 ...
 */
/** Ожидаемая выручка с одного лида, сум — по ней шапка колонки считает «сумму сделок». */
export const LEAD_VALUE_UZS = 850_000;
...
export const COLUMNS = [
  {
    ...
    label: 'Новый лид',
    color: '#2F6FE4',
    // Отдельная настройка от 'calling' — чисто отображение на кнопке, пока
    // лид ещё не сделал первую попытку (см. LeadColumn.jsx комментарий у
    // maxTouchesSourceKey): карточка всё равно уезжает в «Дозвон» сразу
    // после первой отметки, это число не гейтит переход.
    maxTouches: 5,
    hint: {
  ...
  },
  {
    ...
    label: 'Дожим',
    color: '#7C5CBF',
    // См. комментарий у 'calling' — то же для TouchDots.
    maxTouches: 2,
    hint: {
